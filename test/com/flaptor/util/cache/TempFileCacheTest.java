...
public class TempFileCacheTest extends TestCase {
    ...
    private String cacheDir = FileUtil.createTempDir("testcacheTemp", ".tmp").getAbsolutePath();
    ...
    public void setUp() {
        ...
        cache = new FileCache<String> (cacheDir, true, true);
    }
    ...
    public void testRemote() throws RemoteException, UnsupportedEncodingException, ConnectionException {
        ...
        cache.addItem("hola", "como estas2");
