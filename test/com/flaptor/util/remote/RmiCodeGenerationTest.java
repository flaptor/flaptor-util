...
//    @TestInfo(testType = TestInfo.TestType.UNIT, requiresPort = {5000})
    public void testCodeGeneration() throws FileNotFoundException {
        ...
        myInterface = (MyInterface) RmiCodeGeneration.proxy(remote, MyInterface.class);
        assertEquals("hola", myInterface.hello(0));
        
        myInterface = (MyInterface) RmiCodeGeneration.reconnectableStub(MyInterface.class, "context", "localhost", 5000, new ExponentialFallbackPolicy());
        assertEquals("hola", myInterface.hello(0));
